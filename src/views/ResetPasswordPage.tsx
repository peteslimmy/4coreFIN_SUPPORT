  ...
  return (
    <PageTransition>
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden p-4">
        <a href="#reset-form" className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-50 focus:px-4 focus:py-2 focus:bg-primary focus:text-[#fff] focus:rounded-lg focus:text-sm focus:font-semibold">
          Skip to form
        </a>
        <AuthBackground />
            ...
            <div className="relative overflow-hidden rounded-2xl border border-border-subtle bg-surface-card p-6 shadow-card md:p-7">
              ...
              {success ? (
                <div className="text-center py-4 animate-fade-in-stagger">
                  ...
                  <a href="/auth/login" className="inline-flex items-center gap-1.5 text-sm text-accent hover:text-accent-light font-semibold transition">
                    <Eye className="w-3 h-3" /> Sign in with new password
                  </a>
                </div>
              ) : (
                <form id="reset-form" aria-labelledby="reset-heading" onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-surface border rounded-xl pl-9 pr-3 py-3 text-sm text-text-primary placeholder:text-text-muted focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none transition-all focus-ring"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-accent to-accent-light text-[#fff] font-semibold py-3 rounded-xl transition-all duration-150 text-sm cursor-pointer disabled:opacity-50 hover:brightness-110 active:scale-[0.99] shadow-card hover:shadow-card-hover"
                  >
