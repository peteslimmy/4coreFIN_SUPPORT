    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ref={ref}
          id={inputId}
          className={`w-full rounded-lg border bg-surface-elevated px-3 py-2 text-sm text-text-primary placeholder:text-text-muted transition-all duration-200 focus-ring resize-y min-h-[80px] ${
