/**
 * Portal components barrel — extracted from CustomerPortalPage.
 */
export { default as CustomerRecordsView } from './CustomerRecordsView';
export { default as CustomerIdentityStep } from './CustomerIdentityStep';
