...
export const REFERENCE_KINDS: ReferenceKindDef[] = [
  {
    ...
    stringItems: true,
    description: 'Business units that file and receive complaints. Deleting one in active use is blocked.',
    fields: [text('value', 'Business Unit Name', { required: true, placeholder: 'e.g. POSSAP' })],
    columns: [{ key: 'value', header: 'Business Unit' }],
    idOf: str,
  },
  {
    kind: 'providers',
    ...
    stringItems: true,
    description: 'Payment providers handling ticket investigations. Deleting one with open tickets is blocked.',
    fields: [text('value', 'Provider Name', { required: true, placeholder: 'e.g. Paystack' })],
    columns: [{ key: 'value', header: 'Provider' }],
    idOf: str,
  },
  {
    kind: 'categories',
    ...
    stringItems: false,
    description: 'Complaint categories used across ticket classification. Deleting a category in use is blocked.',
    fields: [
